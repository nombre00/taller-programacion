package com.goldenburgers.gestionUsuario.filter;

import com.goldenburgers.gestionUsuario.security.CustomUserDetails;
import com.goldenburgers.gestionUsuario.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (path.startsWith("/actuator/") ||
            ...
            path.startsWith("/api/usuarios/exists/") ||
