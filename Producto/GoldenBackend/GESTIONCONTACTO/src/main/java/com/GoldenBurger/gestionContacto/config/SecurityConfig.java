...
import com.GoldenBurger.gestionContacto.filter.JwtAuthenticationFilter;
...
/**
 * Configuración de Spring Security para GESTIONCONTACTO
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // POST /api/mensajes es PÚBLICO (formulario de contacto)
                        .requestMatchers("POST", "/api/mensajes").permitAll()
