...
import com.example.GestionPedidos.filter.JwtAuthenticationFilter;
...
/**
 * Configuración de Spring Security para GESTIONPEDIDO
...
public class SecurityConfig {
        ...
        public CorsConfigurationSource corsConfigurationSource() {
                ...
                configuration.setAllowedOriginPatterns(Arrays.asList(
                                ...
                                "http://localhost:8083", // Swagger del microservicio GestionPedido
                                "http://127.0.0.1:8083"));
