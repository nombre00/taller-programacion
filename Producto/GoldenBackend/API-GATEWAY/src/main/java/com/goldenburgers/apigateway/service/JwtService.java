...
/**
 * Servicio para generar y validar tokens JWT internos
 */
@Service
public class JwtService {
     ...
     */
    public String generateToken(Map<String, Object> extraClaims, String uid) {
        return buildToken(extraClaims, uid, jwtExpiration);
    }
    ...
    public String generateRefreshToken(String uid) {
        return buildToken(new HashMap<>(), uid, jwtExpiration * 7); // 7 veces más tiempo
    }
